...
#region mysql connector and database creation
connection = pymysql .connect(host = 'localhost', user = 'root', password = '6382582755jK*')
...
path_city = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\City.xlsx"
path_continent = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\Continent.xlsx"
path_country = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\Country.xlsx"
path_item = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\Item.xlsx"
path_mode = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\Mode.xlsx"
path_region = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\Region.xlsx"
path_transaction = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\Transaction.xlsx"
path_type = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\Type.xlsx"
path_user = r"D:\Guvi_MD116\MD116_Jaya_Kumar_K_Details\Tourism_Experience_Analytics\Tourism_Experience_Analytics Data sheets\User.xlsx"
...
#region dataframe for regression and classification
...
#region datacleaning and preprocessing
...
#region regression and classification
with tab1:
...
with tab3:
    ...
    if st.button("Result", type="primary"):
        if options == "Top 5 Country With More Tourist":
            ...
            df_qr = pd.DataFrame(rows, columns=col)
            st.write(df_qr)
            st.bar_chart(df_qr.set_index('attraction')['User Count'])
        
        elif options == "Visit Mode":
            qr = """select   g.visitmode, count(a.userid)  as 'User Count'   from transaction a
            inner join item b on a. AttractionId = b.AttractionId
            inner join city c on b.AttractionCityId = c.CityID
            inner join type d on b.AttractionTypeId = d.AttractionTypeId
            inner join country e on c.countryid = e.countryid
            ...
            df_qr = pd.DataFrame(rows, columns=col)
            st.write(df_qr)
            st.bar_chart(df_qr.set_index('visitmode')['User Count'])
        
        elif options == "Attraction type":
            qr = """select   d.attractiontype , count(a.userid)  as 'User Count'   from transaction a
            inner join item b on a. AttractionId = b.AttractionId
            inner join city c on b.AttractionCityId = c.CityID
            inner join type d on b.AttractionTypeId = d.AttractionTypeId
            inner join country e on c.countryid = e.countryid
            ...
            df_qr = pd.DataFrame(rows, columns=col)
            st.write(df_qr)
            st.bar_chart(df_qr.set_index('attractiontype')['User Count'])
#endregion 
